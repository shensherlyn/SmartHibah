...
const i18nTokens = {
  bm: {
    ...
    svc_card1_f6: "Sesuai Untuk: Satu Aset Penting Untuk Insan Tersayang",
    ...
    svc_card3_f3: "Penerima Hibah: Sehingga 6 Penerima",
    ...
    step1_desc: "Daftar and senaraikan aset seperti rumah, tanah atau simpanan yang ingin dihibahkan.",
    ...
    step3_desc: "Pakar kami akan menyediakan draf dokumen Deklarasi Hibah yang patuh Syariah.",
    ...
    r2_desc: "Sesiapa sahaja yang dipilih (Waris Faraid atau bukan waris). Bagi penerima di bawah umur 18 tahun, ia akan diwakili oleh Penjaga atau Wali yang sah.",
    ...
    r4_desc: "Dokumen pengisytiharan yang mengandungi penawaran (Ijab) dan penerimaan (Qabul) secara rasmi serta bertulis melalui sistem.",
    ...
    sec3_c2_l3: "Emas fizikal, barangan berharga, serta kenderaan yang telah bebas hutang.",
  ...
  en: {
    ...
    svc_card1_f6: "Best For: One Key Asset for a Loved One",
    ...
    svc_card3_f3: "Hibah Recipients: Up to 6 Recipients",
    ...
    step3_desc: "Our experts will prepare a Shariah-compliant draft of the Hibah Declaration.",
   ...
   // Panduan & Informasi Tambahan (EN)
    ...
    r4_desc: "A declaration document containing official offer (Ijab) and acceptance (Qabul) rendered in written form through the system.",
    ...
    sec3_c2_l3: "Physical gold, valuables, and motor vehicles that are debt-free.",
    ...
    a7: "Once the hibah contract is fully executed (upon delivery or Qabd), ownership officially passes to the recipient. If the recipient dies first, the asset becomes part of their estate and will be distributed to their heirs via Faraid. It does not revert to the original donor (unless it involves a parent-to-child gift).",
    q8: "Can overseas assets be registered into the SmartHibah system?",
    a8: "The SmartHibah system is structured specifically in accordance with the Syariah Criminal Offences Enactments and Administration of Islamic Law Acts <strong>within Malaysia only</strong>. For overseas assets, it is subject to international conflict of laws and the civil laws of that particular country.",
